<div class="auth-card" data-aos="fade-up">
    ...
    <div class="auth-body">
        <form action="<?= BASE_URL ?>/index.php?controller=auth&action=verifyAccount" method="POST" class="auth-form">
        ...
        <div class="text-center mt-4">
            ...
            <div id="resend-container">
                <a href="<?= BASE_URL ?>/index.php?controller=auth&action=resendVerifyOtp" id="resend-link" class="resend-link">Gửi lại mã OTP</a>
