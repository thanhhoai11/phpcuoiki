<div class="auth-card" data-aos="fade-up" data-aos-duration="1000">
    ...
    <form action="<?= BASE_URL ?>/?controller=auth&action=resetPassword" method="POST" autocomplete="off" novalidate>
        ...
        <div class="text-center">
            <a href="<?= BASE_URL ?>/?controller=auth&action=login" style="color: #b08d28; font-weight: 600; text-decoration: none;">Quay lại Đăng Nhập</a>
        </div>
    </form>
</div>
