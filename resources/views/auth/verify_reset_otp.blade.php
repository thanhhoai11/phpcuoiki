<div class="auth-card" data-aos="fade-up" data-aos-duration="1000">
    ...
    <form action="<?= BASE_URL ?>/?controller=auth&action=verifyResetOtp" method="POST">
    ...
    <div class="text-center">
        <a href="<?= BASE_URL ?>/?controller=auth&action=resendResetOtp" class="btn btn-link p-0 text-decoration-none mt-1" style="color: #b08d28; font-weight: 500;">
            Gửi lại mã OTP
        </a>
    </div>

    <div class="text-center mt-3">
        <a href="<?= BASE_URL ?>/?controller=auth&action=forgotPassword" style="font-size: 0.85rem; color: #64748b; text-decoration: none;">
