...
<div class="d-flex gap-3 justify-content-center flex-wrap mt-4">
    <a href="<?= BASE_URL ?>/?controller=booking&action=payment&id=<?= $booking['id'] ?>&method=vietqr"
       class="btn btn-success">
        <i class="bi bi-qr-code me-1"></i>Thanh Toán VietQR
    </a>
    <a href="<?= BASE_URL ?>/?controller=booking&action=payment&id=<?= $booking['id'] ?>&method=momo"
       class="btn btn-danger">
        <i class="bi bi-phone me-1"></i>Thanh Toán MOMO
    </a>
    <a href="<?= BASE_URL ?>/?controller=home" class="btn btn-outline-secondary">
        Về Trang Chủ
    </a>
</div>