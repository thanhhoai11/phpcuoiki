...
<div class="search-card">
    <form method="GET" action="<?= BASE_URL ?>/?controller=room&action=search" id="searchForm" novalidate>
    ...
    <div class="col-lg-9">
        ...
        <form id="multiBookingForm" method="GET"
            ...
            <?php foreach ($roomTypes as $i => $type):
                ...
                $imgSrc     = BASE_URL . '/images/rooms/' . $typeId . '.jpg';
                $imgFallback= BASE_URL . '/images/rooms/default.jpg';
            ...
            <div class="room-card room-type-card <?= $i === 0 ? 'open' : '' ?>"
                ...
                <div class="room-body">
                    ...
                    <div style="display:flex;flex-wrap:wrap;gap:10px">
                        ...
                        <?php 
                        // Sử dụng all_rooms để hiển thị cả phòng đã đặt
...
// 3. GIỎ PHÒNG
// ════════════════════════════════════════════════
const neededGuests = <?= (int)($people ?? 1) ?>;
const selected = {};
